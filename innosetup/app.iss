...
OutputDir=${basedir}
OutputBaseFilename=VanguardSetup64
...
Source: "${basedir}\native-win64\Vanguard.exe"; DestDir: "{app}"
Source: "${basedir}\native-win64\Vanguard.jar"; DestDir: "{app}"
...
[UninstallDelete]
Type: filesandordirs; Name: "{%USERPROFILE}\.vanguard\repository2"
